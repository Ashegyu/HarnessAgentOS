...
export const RUNNER_POLICY_BLOCKED = "RUNNER_POLICY_BLOCKED" as const;
...
export const CODE_CHANGE_TASK_NOT_FOUND =
  "CODE_CHANGE_TASK_NOT_FOUND" as const;
export const CODE_CHANGE_APPROVAL_NOT_FOUND =
  "CODE_CHANGE_APPROVAL_NOT_FOUND" as const;
export const CODE_CHANGE_APPROVAL_TASK_MISMATCH =
  "CODE_CHANGE_APPROVAL_TASK_MISMATCH" as const;
export const CODE_CHANGE_APPROVAL_TYPE_MISMATCH =
  "CODE_CHANGE_APPROVAL_TYPE_MISMATCH" as const;
export const CODE_CHANGE_APPROVAL_NOT_APPROVED =
  "CODE_CHANGE_APPROVAL_NOT_APPROVED" as const;
...
export const HARNESS_BINDING_SET_NOT_FOUND =
  "HARNESS_BINDING_SET_NOT_FOUND" as const;
export const HARNESS_BINDING_SET_MISMATCH =
  "HARNESS_BINDING_SET_MISMATCH" as const;
export const HARNESS_BINDING_IN_USE_BY_PROFILE_DELETE =
  "HARNESS_BINDING_IN_USE_BY_PROFILE_DELETE" as const;
