...
Provider 비교와 LLM judge opt-in 기반, read-only viewer list/detail은 구현됐다. viewer attempt drill-down/비교 모드, cost trend 시각화, production latency는 여전히 v2 deferred이며, gate 충족 후 별도 TDD phase로 진행한다.
